...
export default class Application {
    ...
    public static Initialize(width:number,height:number,color:number)
    {
    Application.renderer = PIXI.autoDetectRenderer(width, height);
    (Application.renderer as any).backgroundColor = color;
    ...
    Application.stats.dom.style.left = "10px";
...
Application.Initialize(800,600,0xff0000);
